...
void TASTMenu(void)
{
	...
	POINT_COLOR=RED;
	LCD_ShowString(40,180,200,16,16,"Draw a line segment and 50cm of not less");
	LCD_ShowString(40,200,200,16,16,"Draw a line segment length can be set"); 
...
void TAST1_Menu(void)
{
	...
	LCD_ShowString(20,180,200,16,16,"STATE");
//	LCD_ShowString(20,200,200,16,16,"2:"); 
//	LCD_ShowString(20,220,200,16,16,"3:"); 
