...
unsigned char Rec_String_U1[200]={0};
unsigned char Rec_String_U2[200]={0};
int conut_flag_1=0;
int conut_flag_2=0;
  ...
  if(USART_GetITStatus(USART1, USART_IT_RXNE) != RESET)
   {
    Rec_Dat_U1= USART_ReceiveData(USART1);
     ...
     Rec_String_U1[conut_flag_1]=Rec_Dat_U1;
		 conut_flag_1++;
   }
  ...
  if(USART_GetITStatus(USART2, USART_IT_RXNE) != RESET)
   {
    Rec_Dat_U2= USART_ReceiveData(USART2);
		   Rec_String_U2[conut_flag_2]=Rec_Dat_U2;
		    conut_flag_2++;
   }
...
{
  int i;
while(!USART_GetFlagStatus(USARTx, USART_FLAG_RXNE) || i==2000  )
   {
   	i++;
   }
