...
//加速度+角度+三度陀螺仪
/*角度传感器*/
//	printf("输出角度是%fv ",(float)((ADC1ConvertedValue[0]*100)/4096)*33/1000);
//    printf("x是 %fg ",((float)((ADC1ConvertedValue[4]*100)/4096)*33/1000-1.65)/0.8);
//	delay_ms(1000);
//	printf("y是 %fg ",((float)((ADC1ConvertedValue[5]*100)/4096)*33/1000-1.65)/0.8);
//	delay_ms(1000);
//	printf("z是 %fg\r\n",((float)((ADC1ConvertedValue[6]*100)/4096)*33/1000-1.65)/0.8);
//	delay_ms(1000);
//}
/*角度传感器*/
